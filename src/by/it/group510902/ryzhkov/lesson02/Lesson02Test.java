...
public class Lesson02Test {
    ...
    public void checkB_sheduler() {
        ...
        B_Sheduler.Event[] events = { new B_Sheduler.Event(0, 3), new B_Sheduler.Event(0, 1),
                ...
                new B_Sheduler.Event(1, 3), new B_Sheduler.Event(1, 3), new B_Sheduler.Event(1, 3),
                ...
                new B_Sheduler.Event(3, 5), new B_Sheduler.Event(2, 4), new B_Sheduler.Event(2, 3),
                new B_Sheduler.Event(3, 7),
                new B_Sheduler.Event(4, 5), new B_Sheduler.Event(6, 7), new B_Sheduler.Event(6, 9),
                new B_Sheduler.Event(7, 9),
                new B_Sheduler.Event(8, 9), new B_Sheduler.Event(4, 6), new B_Sheduler.Event(8, 10),
                new B_Sheduler.Event(7, 10)
        };

        List<B_Sheduler.Event> starts = instance.calcStartTimes(events, 0, 10); // рассчитаем оптимальное заполнение
                                                                                // аудитории
