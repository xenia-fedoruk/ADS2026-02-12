package by.it.group551001.biarezina.lesson03;
...
public class A_Huffman {
    ...
    String encode(InputStream inputStream) throws FileNotFoundException {
        ...
        while (priorityQueue.size() != 1) {
            A_Huffman.Node element1 = priorityQueue.poll(); // Удаляет и возвращает элемент
        ...
        if (root != null) {
            root.fillCodes(""); // Запускаем рекурсивное заполнение codes
        }
        ...
        //.....
        for (char c : s.toCharArray()) {
            sb.append(codes.get(c)); // Добавляем код каждого символа
        }
