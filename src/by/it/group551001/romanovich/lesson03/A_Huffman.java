package by.it.group551001.romanovich.lesson03;
...
public class A_Huffman {
    ...
    abstract class Node implements Comparable<Node> {
        ...
        private final char minSymbol;

        //конструктор по умолчанию
        private Node(int frequence, char minSymbol) {
        ...
        public int compareTo(Node o) {
            int byFreq = Integer.compare(frequence, o.frequence);
            if (byFreq != 0) {
                return byFreq;
            }
            return Character.compare(minSymbol, o.minSymbol);
        }
    }
    ...
    private class InternalNode extends Node {
        ...
        InternalNode(Node left, Node right) {
            super(left.frequence + right.frequence, (char) Math.min(left.minSymbol, right.minSymbol));
            this.left = left;
            this.right = right;
        }
