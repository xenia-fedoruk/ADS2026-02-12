package by.it.group551002.dovgash.lesson02;
/*
Даны
1) объем рюкзака 4
...
public class C_GreedyKnapsack {
    ...
    double calc(InputStream inputStream) throws FileNotFoundException {
        ...
        //ваше решение.
        //отсортировать по удельной стоимости, добавлять пока не забьем, последнюю вещь взять которая наивысшая
        //по уделке и порезать ее.
